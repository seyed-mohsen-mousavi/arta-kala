...
const footerData = [
  {
    ...
    content: (
      <p className="text-lg font-medium text-black mt-10 max-w-[460px]">
        ...
        مناسب آن‌ها، به دنبال خرید راحت و رضایت‌بخش ابزارآلات برای همراهان خودش
        است و این مهم را با مهیا کردن امکان بررسی فنی و کاربردی ابزارآلات و
        ارائه محتوای مناسب و غنی محقق می‌سازد.
      </p>
    ),
  },
  {
  ...
  },
  {
    title: "راهنمای خرید",
    links: [
      { href: "https://abzarmart.com/payment-method/", label: "روش های پرداخت" },
      { href: "https://abzarmart.com/customer-service/", label: "شرایط ارسال سفارشات" },
      { href: "https://abzarmart.com/purchasing-process/", label: "راهنمای خرید از تکنو صاف" },
      { href: "https://abzarmart.com/proform-invoice/", label: "راهنمای پیش فاکتور" },
    ],
  },
  {
    ...
    links: [
      ...
      { href: "https://abzarmart.com/return-conditions/", label: "شرایط بازگشت کالا" },
    ],
    content: (
      <div className="mt-6 text-center">
        <a href="https://emalls.ir/Shop/833/" target="_blank" rel="noopener noreferrer">
          <img
  ...
  return (
    <footer className="w-full bg-[#fed75c] block font-pelak font-medium py-7">
      <div
        ...
        className="flex flex-wrap justify-between px-20 md:px-6 mx-auto max-w-screen-xl"
      >
      ...
      <div id="wze60" className="text-center pt-10 mx-auto">
        <p className="text-lg text-gray-600 -mt-16" style={{ fontFamily: "pelak,tahoma,serif" }}>
